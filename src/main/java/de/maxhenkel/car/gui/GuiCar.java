...
public class GuiCar extends GuiBase {
    ...
    public String getTempString() {
        if (Config.tempInFarenheit) {
            return new TextComponentTranslation("gui.car_temperature_farenheit", String.valueOf(getTemperatureFarenheit())).getFormattedText();
        } else {
            return new TextComponentTranslation("gui.car_temperature_celsius", String.valueOf(getTemperatureCelsius())).getFormattedText();
        }
    }
