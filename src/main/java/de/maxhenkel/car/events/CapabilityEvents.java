...
public class CapabilityEvents {
    ...
    public void capabilityAttachTileEntity(AttachCapabilitiesEvent<TileEntity> event) {
        if (event.getObject() == null || event.getObject().getType() == null || event.getObject().getType().getRegistryName() == null || !event.getObject().getType().getRegistryName().getNamespace().equals(Main.MODID)) {
            return;
        }
