...
import de.maxhenkel.car.UpdateChecker;
import de.maxhenkel.car.UpdateChecker.IUpdateCheckResult;
...
public class UpdateCheckEvents {
	...
	private void showUpdateMessage(EntityPlayer player, String updateURL) {
		...
		player.addChatMessage(new TextComponentString(msg).appendSibling(download));
	}
