...
public class MessageControlCar implements Message<MessageControlCar> {
    ...
    public static final CustomPacketPayload.Type<MessageControlCar> TYPE = new CustomPacketPayload.Type<>(Identifier.fromNamespaceAndPath(CarMod.MODID, "control_car"));
