...
public class PartBodySport extends PartBody {
    ...
    public PartBodySport(Identifier texture, String materialTranslationKey) {
        super(new OBJModel(Identifier.fromNamespaceAndPath(CarMod.MODID, "models/entity/sport_body.obj")), texture, new Vector3d(0D, 4D / 16D, 0D), "sport", materialTranslationKey);
