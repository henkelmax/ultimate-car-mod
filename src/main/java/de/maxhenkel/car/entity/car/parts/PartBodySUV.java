...
public class PartBodySUV extends PartBody {
    ...
    public PartBodySUV(Identifier texture, String materialTranslationKey) {
        ...
        this.fuelEfficiency = () -> CarMod.SERVER_CONFIG.bodySUVFuelEfficiency.get().floatValue();
        this.acceleration = () -> CarMod.SERVER_CONFIG.bodySUVAcceleration.get().floatValue();
        this.maxSpeed = () -> CarMod.SERVER_CONFIG.bodySUVMaxSpeed.get().floatValue();
    }
