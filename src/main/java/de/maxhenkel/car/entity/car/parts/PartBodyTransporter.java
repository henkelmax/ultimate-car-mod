...
public class PartBodyTransporter extends PartBody {
    ...
    public PartBodyTransporter(OBJModel model, Vec3d offset, Vec3d[] wheelOffsets, Vec3d[] playerOffsets, Vec3d numberPlateOffset, float width, float height, float minRotationSpeed) {
